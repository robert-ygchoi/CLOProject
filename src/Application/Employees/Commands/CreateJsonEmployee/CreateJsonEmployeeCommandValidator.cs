...
public class CreateJsonEmployeeCommandValidator : AbstractValidator<CreateJsonEmployeeCommand>
{
    public CreateJsonEmployeeCommandValidator()
    {
        ...
        RuleFor(e => e.Tel)
            ...
            .WithMessage("{ProperyName}은 010-0000-0000 또는 011-0000-0000 또는 017-0000-0000 이여야 합니다.");

        // NOTE - Check for datetime
        RuleFor(e => e.Joined)
            .NotEmpty()
            .Must(BeValidJoined)
            .WithMessage("{ProperyName}은 yyyy-MM-dd 여야 합니다.");
    }
